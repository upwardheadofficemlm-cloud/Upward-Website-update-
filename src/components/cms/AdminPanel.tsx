        ...
        <div className="mb-4 p-4 bg-gradient-to-r from-[#004FED]/10 to-[#0066FF]/10 dark:from-[#004FED]/20 dark:to-[#0066FF]/20 rounded-xl border border-[#004FED]/20 dark:border-[#004FED]/30 relative z-10 shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="flex items-center justify-center space-x-2 px-3 py-2 bg-[#004FED] text-white rounded-lg text-xs font-semibold hover:bg-[#0066FF] transition-colors shadow-md hover:shadow-lg"
            ...
            <button
              ...
              className="flex items-center justify-center space-x-2 px-3 py-2 bg-green-600 text-white rounded-lg text-xs font-semibold hover:bg-green-700 transition-colors shadow-md hover:shadow-lg"
